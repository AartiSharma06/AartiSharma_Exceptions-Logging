...
import com.aarti.maven.CompoundInterest;
import com.aarti.maven.SimpleInterest;

public class MainInterest {
		
		private static final Logger LOGGER  = LogManager.getLogger(MainInterest.class);
